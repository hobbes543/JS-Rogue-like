...
// number of acrtors per level, including player
var ACTORS = 10;

// the structure of the map
var map;

// the ascii display, as a 2d array of characterSet
var asciidisplay;

// a list of all actor; 0 is the player
var player;
var actorList;
var livingEnemies;
...
function moveTo(actor, dir) {
	...
	if (actorMap[newKey] != null) {
		// decrement hitpoints of the actor at the destination
		var victim = actorMap[newKey];
		victim.hp--;
		
		// if the victim is dead remove its references
		if (victim.hp == 0) {
...
function aiAct(actor) {
	...
	if (Math.abs(dx) + Math.abs(dy) > 6)
		// try to wal in random directions until you suceed once
